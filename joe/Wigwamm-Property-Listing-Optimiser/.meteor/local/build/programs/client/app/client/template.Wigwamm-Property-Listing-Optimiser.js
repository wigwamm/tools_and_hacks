...
UI.body.contentParts.push(UI.Component.extend({render: (function() {
  var self = this;
  return [ HTML.Raw('<div id="header"><p><img src="logo.png"> Wigwamm Pricing Optimiser</p></div>\n    '), HTML.DIV({
    id: "youThink"
